...
export const createIx = (
    funderPubkey, associatedTokenAccountPublicKey, ownerPublicKey, tokenMintPublicKey,
    connection
) =>
...
export const createAssociatedTokenAccount = async(
    ...
    if(feePayerSignsExternally){
        ...
        await sendTxUsingExternalSignature([ix], connection, feePayer, [], ownerAddress, signTransaction);
    }
