...
export const JobPostInfoState_SIZE = 1 + 1 + 32 + 32 + 128 + 256 + 1024 + (32*4)+10+10 + 16 + 8 + 8 + 8 + 8 + 8 + (64*10)+10+10 + 512 + 32 + 64 + 64 + 8; 
export class JobPostInfoState {
    ...
    static serializeSaveJobPostInfoInstruction(updatedObj /*Buffer*/) {
