...
export const UserCandidateInfoState_SIZE = 1 + 32 + 32 + 32 + 256 + 128 + 512 + (64*10)+10+10 + 64 + 32 + 32 + 16 + 1 + 1 + 1 + 1 + 1 + 1;
export const ProjectInfoState_SIZE = 1+32+1+64+1024+650+256+660+64+64+32+8;
export const ContactInfoState_SIZE = 1+32+64+16+128+128+128+128+128+128+128+128+128+128+128;
export const EducationInfoState_SIZE = 1+32+1+128+64+64+64+64+64+700+700+1024+1+1+650+8;
export const WorkExperienceInfoState_SIZE = 1+32+1+64+128+1+64+64+512+256+128+8;
export class UserCandidateInfoState {
    ...
    static serializeUpdateApplicantInfoInstruction(updatedObj /*Buffer*/) {
		...
		updateAccountInstructionSchema.encode({...updateApplicantInfoData }, buffer)
