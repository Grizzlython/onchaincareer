...
export const WorkflowInfoState_SIZE = 1 + 1 + 16 + 32 + 32 + 32 + 32 + 8 + 1 + 8 + 8 + 8;
export class WorkflowInfoState {
	...
	static deserialize(buffer /*Buffer*/) {
		...
		try {
			...
			return new WorkflowInfoSta(decodedData)
        } catch(error) {
			console.log('Deserialization error in WorkflowInfoSta :', error)
			return null
		}
	}
    ...
    static serializeSaveWorkflowInfoInstruction(updatedObj /*Buffer*/) {
