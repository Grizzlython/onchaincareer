        ...
        <div className="w-lg-50 ml-lg-auto">
          ...
          >
            ...
            <div className="single-item">
              <img src={imgG1.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG2.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG3.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG4.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG5.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG6.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG7.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG8.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG9.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG10.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG11.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG12.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG13.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG14.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG15.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG16.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG17.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG18.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG19.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG20.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG21.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG22.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG23.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG24.src} alt="" />
            </div>
            <div className="single-item">
              <img src={imgG25.src} alt="" />
            </div>
          </div>
          {/* <!-- gallery end --> */}
        </div>
